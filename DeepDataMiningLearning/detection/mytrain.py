...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="/Users/arielle/Desktop/CMPE 258/DeepDataMiningLearning/data", type=str, help="dataset path") #"/data/cmpe249-fa23/WaymoCOCO/"
    parser.add_argument("--annotationfile", default="/Users/arielle/Desktop/CMPE 258/DeepDataMiningLearning/data/annotations", type=str, help="dataset annotion file path, e.g., coco json file") #annotations_train200new.json
    parser.add_argument(
        "--dataset",
    ...
    parser.add_argument(
        "--lr-step-size", default=15, type=int, help="decrease lr every step-size epochs (multisteplr scheduler only)"
    )
    parser.add_argument(
        "--lr-steps",
        default=[16, 22],
    ...
    parser.add_argument("--output-dir", default="/Users/arielle/Desktop/CMPE 258/DeepDataMiningLearning/DeepDataMiningLearning/output", type=str, help="path to save outputs")
